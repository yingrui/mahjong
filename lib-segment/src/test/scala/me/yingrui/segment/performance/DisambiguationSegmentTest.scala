...
class DisambiguationSegmentTest {
  ...
  def should_scan_context_freq_for_Computer_and_Chance() {
    val str = "计算机会成本将会大大增加成功的机会。（Context: 欢呼我们的机会！机会！机会！）"
  ...
  def should_scan_context_freq_for_Learning_and_Student() {
    val str = "该学生物理成绩不甚理想，学生物比较好！生物相比物理简单"
    val worker = SegmentWorker()
