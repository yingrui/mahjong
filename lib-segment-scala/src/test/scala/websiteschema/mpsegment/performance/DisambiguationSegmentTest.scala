...
//
//    @Test
//    def should_scan_context_freq_for_Computer_and_Chance() {
//        var str = "计算机会成本将会大大增加成功的机会。（Context: 欢呼我们的机会！机会！机会！）"
...
//        var str = "乒乓球拍卖完了。这里所有的球拍都物美价廉，这最后几个球拍便宜一点，你就都拿走吧？要不再送你几个其它球拍。（Context: 球拍球拍球拍球拍球拍球拍球拍。乒乓乒乓乒乓乒乓乒乓乒乓）"
//        var engine = SegmentEngine.getInstance()
//        var worker = engine.getSegmentWorker()
//
//        var old = worker.isUseContextFreqSegment()
...
//
//    @Test
//    def should_scan_context_freq_for_Learning_and_Student() {
//        var str = "该学生物理成绩不甚理想，学生物比较好！生物相比物理简单"
//        var engine = SegmentEngine.getInstance()
//        var worker = engine.getSegmentWorker()
//
//        var words = worker.segment(str)
...
//
//    @Test
//    def should_know_And_and_Kimono() {
//        var str = "化妆和服装"
//        var engine = SegmentEngine.getInstance()
//        var worker = engine.getSegmentWorker()
//
...
//    @Ignore
//    @Test
//    def should_know_Handle_and_TakeAway() {
//        var str = "这个把手坏了。"
//        var engine = SegmentEngine.getInstance()
//        var worker = engine.getSegmentWorker()
//
...
//    @Ignore
//    @Test
//    def should_know_General_and_Would() {
//        var str = "产量三年中将增长两倍。"
//        var engine = SegmentEngine.getInstance()
//        var worker = engine.getSegmentWorker()
//
