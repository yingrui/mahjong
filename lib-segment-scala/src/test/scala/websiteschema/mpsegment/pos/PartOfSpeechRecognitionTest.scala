...
//        var result = SegmentEngine.getInstance().getSegmentWorker().segment(testInput)
...
//
//    @Test
//    def should_save_POS_Matrix() throws IOException {
//        var recognizer = new POSRecognizer()
//        var file = new File("pos.dat")
//        var writeHandler = new SerializeHandler(file, SerializeHandler.MODE_WRITE_ONLY)
//        recognizer.save(writeHandler);
//    }
//
//    @Test
//    def should_load_POS_Matrix() throws IOException {
//        var recognizer = new POSRecognizer()
//        var file = new File("pos.dat")
//        var readHandler = new SerializeHandler(file, SerializeHandler.MODE_READ_ONLY)
//        recognizer.load();
//        file.deleteOnExit();
//    }
//}
